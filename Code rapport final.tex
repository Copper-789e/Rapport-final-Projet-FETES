...
\begin{document}
	...
	\begin{itemize}
		...
		\item 3.4 : Boîtiers StreamLine permettant l'acquisition des valeurs de la sonde fil chaud
		\item 3.5 : Boîtier d'acquisition permettant le formatage des données du boîtier StreamLine au logiciel StreamWare dans l'ordinateur.
	\end{itemize}
	Ce sont les instruments minimums supplémentaires pour l'acquisition de données pour l'utilisation des tubes de Pitot (Manomètre), et le fil chaud (StreamLine, boîtier d'acquisition et ordinateur). 
	...
	\begin{figure}[h!]
		...
		\end{minipage}
	\end{figure}
	Voici un exemple de présentation d'un fil chaud. On peut lire sur l'étiquette qu'il s'agit d'un fil chaud coudé 1D de référence \textbf{55P15}, avec les constantes suivantes:
	\begin{itemize}
	...
	On pourra mettre en place deux manipulations suivant le même principe mais pour les spécifications suivantes:
	\begin{itemize}
	...
	\textbf{Précaution à suivre} pour le bon déroulement des manipulations :
	\begin{itemizeFB}
