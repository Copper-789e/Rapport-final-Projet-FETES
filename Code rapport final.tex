...
\begin{document}
	...
	\begin{table}[h!]
		...
		\begin{minipage}{0.45\textwidth}
			...
			\begin{tabular}{|c|c|c|c|}
				...
				275   & 2,20 & 11,77 & 11,5 \\ \hline
				277   & 2,18 & 11,30 & 9,5  \\ \hline
				279   & 2,17 & 10,84 & 7,5  \\ \hline
				281   & 2,16 & 10,43 & 5,5  \\ \hline
				283   & 2,14 & 9,58  & 3,5  \\ \hline
				285   & 2,10 & 8,51  & 1,5  \\ \hline
				286   & 2,07 & 7,34  & 0,5  \\ \hline
				286,5 & 2,03 & 6,29  & 0    \\ \hline
			\end{tabular}
			\caption{Synthèse des mesures (Série 1)}
		\end{minipage}
		\hfill % Ajoute un espace flexible entre les deux minipages
		% --- Bloc Série 2 ---
		\begin{minipage}{0.45\textwidth}
			\centering
			\begin{tabular}{|c|c|c|c|}
			...
			\end{tabular}
			\centering
			\caption{Synthèse des mesures (Série 2)}
		\end{minipage}
	\end{table}
	...
	\begin{figure}[!h]
		\begin{minipage}{0.3\textwidth}
			...
			\begin{tikzpicture}
				\begin{axis}[
					title={Série 1 : $U_{cal}$ en fonction de $z_{cal}$},
					xlabel={$z_{cal}$},
					ylabel={$U_{cal}$},
					grid=major,
					...
					\addplot[blue, mark=*, thick] coordinates {
						(11.5, 11.77) (9.5, 11.30) (7.5, 10.84) (5.5, 10.43) 
						(3.5, 9.58) (1.5, 8.51) (0.5, 7.34) (0, 6.29)
					};
				\end{axis}
			\end{tikzpicture}
			\centering
			\caption{Je sais pas 2}
		\end{minipage}
		\hfill
		\begin{minipage}{0.3\textheight}
			\begin{tikzpicture}
