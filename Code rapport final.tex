...
\begin{document}
	...
	\begin{figure}[h!]
		...
		\end{minipage}
	\end{figure}
	Voici un exemple de présentation d'un fil chaud, on peut y lire que l'étiquette que nous avons affaire à un fil chaud coudé 1D de référence \textbf{55P15}, avec les constantes suivantes:
	\begin{itemize}
