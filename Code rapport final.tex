...
\logo{logo.png}
\title{Anémométrie à Température Constante}
\subtitle{Étude expérimentale d’un jet turbulent dans un tube cylindrique}
...
\begin{document}
	...
	L’anémométrie à fil chaud est une technique expérimentale de mesure des vitesses d’écoulement, utilisée pour caractériser les fluctuations de vitesse dans des régimes turbulents. Basée sur la mesure de la dissipation thermique d’un fil métallique chauffé (en platine ou en tungstène), cette méthode permet d’obtenir des mesures fines et rapides des composantes locales de la vitesse dans un fluide, qu’il soit gazeux ou liquide. Ce système est largement utilisé en recherche et dans l’industrie, car les principes de l’anémométrie sont directement liés aux problématiques de contrôle des écoulements en aéronautique, en automobile ou en thermique industrielle.\\
	...
	\begin{itemizeFB}
		\item \textbf{Scientifique} : il s’agit de comprendre et d’expliciter les mécanismes physiques permettant l’utilisation de ce dispositif, tout en mobilisant des outils numériques (Streamline, Comsol Multiphysics) afin de modéliser le phénomène ;
		\item \textbf{Pédagogique} : il vise à concevoir un TP ainsi qu’un support expérimental dédié à la mesure de vitesse.\\
	\end{itemizeFB}
	
	Nous utiliserons, dans le cadre de ce projet, le principe de l’\textbf{anémométrie à température constante (ATC)}, car nous ne disposons pas de l’équipement nécessaire pour réaliser des mesures en \textbf{anémométrie à courant constant (ACC)}. Voici un comparatif synthétique des deux méthodes :
	...
	\begin{tcolorbox}[colback=gray!5, colframe=gray!50, arc=0mm, title=Suggestions de Protocoles expérimentaux par Dantec Dynamics]
		\tiny
	...
	\subsection{Études de la couche limite, à différentes puissances de la soufflerie}
	...
	\newpage
	\subsubsection{Qualification de la turbulence}
	\begin{table}[h]
		\centering
		\tiny
		\begin{tabular}{l|cccccccccccc}
			\toprule
			\textbf{Moyenne ($m/s$)} & 0,74 & 1,93 & 3,11 & 3,83 & 5,01 & 6,31 & 7,97 & 8,70 & 9,97 & 11,77 & 14,21 & 18,07 \\
			\textbf{Variance ($m^2/s^2$)} & 0,002 & 0,010 & 0,028 & 0,046 & 0,074 & 0,106 & 0,164 & 0,207 & 0,294 & 0,358 & 0,532 & 0,781 \\
			\textbf{Intensité} & 6,67 & 5,21 & 5,36 & 5,62 & 5,41 & 5,15 & 5,08 & 5,23 & 5,44 & 5,09 & 5,13 & 4,89 \\
			\midrule
			\textbf{Re} & 6340 & 16657 & 26798 & 33019 & 43162 & 54339 & 68641 & 74905 & 85864 & 101329 & 122335 & 155623 \\
			\textbf{Formule empirique} & 5,36 & 4,75 & 4,47 & 4,36 & 4,21 & 4,09 & 3,98 & 3,93 & 3,87 & 3,79 & 3,70 & 3,59 \\
			\bottomrule
		\end{tabular}
		\caption{Données expérimentales et calculées en couche limite 55P11}
	\end{table}
